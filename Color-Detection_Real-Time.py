...
def draw_function(event, x, y, flags, param):
    global b, g, r, x_pos, y_pos, clicked, color_displayed
...
while True:
    ...
    brightness_factor = 1.5  # You can adjust this value based on your preference
    frame = cv2.convertScaleAbs(frame, alpha=brightness_factor, beta=0)    

    if clicked and color_displayed:
        ...
        if r + g + b >= 600:
            ...
            cv2.rectangle(frame, (50, 50), (frame.shape[1] // 2, frame.shape[0] // 2), (0, 255, 0), thickness=2)
